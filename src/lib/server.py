...
class Server(Chat):
    ...
    def welcome(self):
        ...
        w = []
	w.append("     _____________________________________________________    ")
        w.append("   /                                                       \  ")
        w.append("  |            *** Welcome to PyTETA Server ***             | ")
        w.append("  |       https://github.com/rogeriolino/pyteta  v1.0.3     | ")
        w.append("  |                                                         | ")
        w.append("  |                   NO FLOOD, PLEASE !!!                  | ")
        w.append("   \______  ______________________________________________ /  ")
        w.append("         | /                                                  ")
        w.append("         |/                                                   ")
        w.append("         '                                                    ")
        w.append(" ( ＾◡＾)                                                     ")
